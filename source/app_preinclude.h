...
#elif defined __HW_BLE_UWB_G2_H || defined __HW_VENUS_EVT1_H
    /*! Configure Flags to ease power measurements */
    //#define gAppPowerMeasurement            1
...
/*! By default, gAppIdleTaskPriority_c is 8, but we need to add some tasks in project.
 * So set gMainThreadPriority_c to 8 and gAppIdleTaskPriority_c to 9 .
 */
//Modify :NXP-V0001 (Ken) -20240424
#if (defined(UWB_FEATURE_SUPPORT) && (UWB_FEATURE_SUPPORT == 1U))
#define gMainThreadPriority_c                  (7 + NUM_OF_UWB_TASK)
#define gAppIdleTaskPriority_c                 (8 + NUM_OF_UWB_TASK)
#endif
           
/*! Defines number of OS events used */
//Modify :NXP-V0001 (Ken) -20240424
#if (defined(UWB_FEATURE_SUPPORT) && (UWB_FEATURE_SUPPORT == 1U))
#define osNumberOfEvents                5 + NUM_OF_UWB_TASK
#else
...
//Modify :NXP-V0001 (Ken) -20240424
#if (defined(UWB_FEATURE_SUPPORT) && (UWB_FEATURE_SUPPORT == 1U))
#define gTotalHeapSize_c                (8500) + (2048 * NUM_OF_UWB_TASK)
#else
